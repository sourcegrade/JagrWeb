...
class GradingJob {
    ...
    var submission: Submission.Archive? = null
    var submissionUpload: SubmissionUpload.Archive? = null

    @Entity(discriminator = "GradingJob.Reference")
    @Serializable
    class Reference {
        var finishedUtc: Instant? = null
        var batchId: ObjectId? = null
        var jobId: Int? = null
        var status: String? = null
    }
}
